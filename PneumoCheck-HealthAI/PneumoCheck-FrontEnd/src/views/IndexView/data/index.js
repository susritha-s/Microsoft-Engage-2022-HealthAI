export const reviews = [
  // {
  //   logo: 'https://www.shareicon.net/data/256x256/2016/04/07/746116_apple_512x512.png',
  //   title: 'Apple',
  //   feedback:
  //     'The very best deep learning model we have used before',
  // },
  // {
  //   logo: 'https://assets.maccarianagency.com/the-front/logos/atlassian.svg',
  //   title: 'Atlassian',
  //   feedback:
  //     'We highly recommend this product to anyone',
  // },
];

export const support = {
  //items: ['Speedy', 'Global team', '5 Star reviews', 'Experts'],
  team: [
    {
      authorPhoto: {
